...
<body>
    ...
    <div class="row">
        <div class="column" >
            <div class="card" style="margin-left: calc(50% - 95px);">
                <video src='../../img/<?php echo $signo->definiciones[0] ?>.mp4' >
            </div>
        </div>
        <div class="column">
            <div class="buscador">
            <div class="item">
                    ...
                    <div class="colec-boton" id="conf">
                        ...
                        for($i = 0; $i < count($configuracion); $i++){
                            if( $configuracion[$i] != '_' ){
                                echo "<img src='../../img_buscador/configuracion/". $configuracion[$i] .".PNG'>";
                            }
                        }
                        ?>
                ...
                <div class="item">
                    <h1>Orientación</h1>
                    <div class="colec-boton">
                        <?php echo "<img src='../../img_buscador/orientacion/". $signo->orientacion .".jpg'>"; ?>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <?php
                        ...
                        for($i = 0; $i < count($movimiento); $i++){
                            if( $movimiento[$i] != '_' ){
                                echo "<img src='../../img_buscador/movimiento/". $movimiento[$i] .".PNG'>";
                            }
                        }
                        ?>
                ...
                <div class="item">
                    <h1>Espacio</h1>
                    <div class="colec-boton">
                        <?php echo "<img src='../../img_buscador/espacio/". $signo->espacio .".PNG'>"; ?>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="colec-boton">
                        <?php
                        if($signo->no_manual){
                            echo "<img src='../../img_buscador/no_manual/". $signo->no_manual .".PNG'>";
                        }
                        ?>
                    </div>
                </div>
        ...
        <div class="column">
            <div class="tablas">
                <?php
                $definiciones = $signo->definiciones;
                for($i = 1; $i < count($signo->definiciones); $i++){
                    echo"
                    <div class='card'>
                        <video src='../../img/" . $definiciones[$i] . ".mp4'>
                    </div>
                    ";
                }
                ?>
    ...
    <script src="../../helpers/playVideo.js"></script>
    <div class="footer">

...
function call($controller, $action){
    ...
    switch($controller){ //se añadirían los demás controladores al switch, por el momento solo tenemos el controlador de usuario, iremos añadiendo según aumentemos el código
        case 'signo':
            require_once('models/signo.php'); //en este archivo configuraremos el acceso a la base de datos y funciones CRUD de usuario
            $controller= new SignoController(); //instancia de UsuarioController (de usuario_controller.php)
            break; 
